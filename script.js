...
(function initLang() {
    const translations = {
        fr: {
            ...
            'hero.desc':            'Salut c\'est Brunoo ! Je suis un rédacteur de script spécialisé dans les formats longs et courts (Short/Reels). J\'ai pu écrire dans de nombreuses niches, allant du storytelling au Storytime, en passant par la muscu et l\'actu rap. Mes tarifs sont de 12€ le short et 45 centimes le mot pour une vidéo longue, mais évidemment c\'est ajustable.',
        ...
        en: {
            ...
            'hero.tagline':         'The writer who will exceed your expectations.',
            'hero.desc':            'Hey, I\'m Brunoo! I\'m a script writer specialized in long and short formats (Shorts/Reels). I\'ve written across many niches — from storytelling to Storytime, fitness, and rap news. My rates are €12 per short and €0.45 per word for long-form videos, but that\'s always open to discussion.',
            ...
            'clients.subtitle':     'Creators I helped with script writing.',
            ...
            'contact.subtitle':     'Ready to work together? Hit me up now.',
